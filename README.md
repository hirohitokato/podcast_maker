...
Each episode is written to `output/<episode-json-stem>/`: the final MP3 and normal, bilingual,
slow, and shadowing section MP3s. The final MP3 includes guides and jingle transitions,
